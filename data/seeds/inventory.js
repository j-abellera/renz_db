...
exports.seed = async function(knex) {
  ...
  await knex('renz_inventory').insert([
    ...
    { item_name: 'miso glaze tuna', category: 'poke', price: 9.50, count: 10 },
    ...
    // bombs
    { item_name: 'spicy tuna inari bomb', category: 'bombs', price: 8.00, count: 10 },
    ...
    { item_name: 'spam fried rice', category: 'rice', price: 3.50, count: 10 },
    { item_name: 'kimchi spam fried rice', category: 'rice', price: 4.50, count: 10 },

    // musubi
    { item_name: 'spam musubi', category: 'musubi', price: 2.50, count: 10 },
    { item_name: 'fried rice musubi', category: 'musubi', price: 4.00, count: 10 },
    ...
    { item_name: 'ocean salad', category: 'sides', price: 2.50, count: 10 },
